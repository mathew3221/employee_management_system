                        ...
                        <?php foreach ($leave_type as $i => $lt) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-leave-id="<?php echo $lt['id']; ?>"><i class="fas fa-trash-alt"></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        document.getElementById('searchBar').addEventListener('input', function() {
            ...
            rows.forEach(row => {
                let leaveType = row.cells[1].innerText.toLowerCase();
                if (leaveType.includes(filter)) {
                    row.style.display = '';
                } else {
